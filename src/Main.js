...
import {StatusBar, SafeAreaView, Text, Dimensions, ScrollView, View, TouchableOpacity, Pressable, StyleSheet, Button} from 'react-native';
...
function Main({navigation}) {
    ...
    const _addTask = () =>{ //iconButton onPressOUt에 대한 콜백 함수
        ...
        const newTaskObject = {
            [ID]: {id: ID, text: newTask, completed: false, edit_check: false, emotion:'❔'}, 
